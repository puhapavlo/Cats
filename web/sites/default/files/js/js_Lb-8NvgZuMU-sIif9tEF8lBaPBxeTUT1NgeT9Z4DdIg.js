...
const modalEditConfirm = document.querySelector('.form-edit-confirm');
const cancelEditBtn = document.querySelector('.form-cancel-edit-confirm');
const idItemEdit = document.querySelector('.form-id-item-edit');

editBtns.forEach(editBtn => {
  editBtn.addEventListener('click', () => {
    modalEditConfirm.classList.add('active');
...
cancelEditBtn.addEventListener('click', (e) => {
  e.preventDefault();
  modalEditConfirm.classList.remove('active');
});
;
/**
* DO NOT EDIT THIS FILE.
