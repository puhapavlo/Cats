...
multipleCheckboxes.forEach(checkbox => {
  checkbox.addEventListener('change', () => {
    if(checks.includes(checkbox.dataset.dataset.itemid)){
      checks.splice(0, checks.indexOf(0, checkbox.dataset.dataset.itemid))
    }
    else{
      checks.push(checkbox.dataset.dataset.itemid);
    }
  })
})
;
