...
const cancelBtn = document.querySelector('.form-cancel-edit');
const idItem = document.querySelector('.form-id-item-edit');

editBtns.forEach(editBtn => {
  editBtn.addEventListener('click', () => {
    modalDelete.classList.add('modalEdit_active');
    idItem.value = editBtn.dataset.itemid;
  })
});

cancelBtn.addEventListener('click', (e) => {
  e.preventDefault();
  modalDelete.classList.remove('modalEdit_active');
});
;
/**
* DO NOT EDIT THIS FILE.
